    ...
    gifts: [
      {
        ...
        name: '正山小种红茶礼盒',
        desc: '武夷红茶 · 100g',
        image: '/gifts/l3-tea-zhengshan.jpg',
        quantity: 3,
      },
      {
        id: 'l3-jinjunmei',
        name: '金骏眉红茶礼盒',
        desc: '武夷金芽 · 100g',
        image: '/gifts/l3-tea-jinjunmei.jpg',
        quantity: 3,
      },
      {
        id: 'l3-chenpi',
    ...
    gifts: [
      {
        ...
        name: '《民法典》实用版',
        desc: '婚姻家庭编司法解释全新修订',
        image: '/gifts/l4-book-minfadian.png',
        quantity: 3,
      },
      {
        id: 'l4-eerguna',
        name: '《额尔古纳河右岸》',
        desc: '迟子建 · 茅盾文学奖',
        image: '/gifts/l4-book-eerguna.png',
        quantity: 3,
      },
      {
        id: 'l4-ditan',
      ...
      },
      {
        ...
        name: '《成语大词典》',
        desc: '商务印书馆 · 双色本',
        image: '/gifts/l4-book-chengyu.png',
        quantity: 3,
      },
    ],
  },
